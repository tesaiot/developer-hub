 ...
 *
 */
/* PSA crypto required for OPTIGA Trust M integration (mbedtls_pk_setup_opaque)
 * Note: PSA AEAD encrypt has known bug in wifi-core v3.1.0 - needs fix
 */
...
/* Fix PSA AEAD PSA_ERROR_INSUFFICIENT_MEMORY by avoiding buffer copy allocation */
#define MBEDTLS_PSA_ASSUME_EXCLUSIVE_BUFFERS
#define MBEDTLS_PLATFORM_MEMORY
#define MBEDTLS_SHA256_C
#define MMEDTLS_PSA_CRYPTO_BUILTIN_ALG_SHA_256
...
#define MBEDTLS_ECP_DP_SCEP256R1_ENABLED
#define MBEDTLS_ECP_DP_SCEP384R1_ENABLED
 ...
 */
/* TLS Version Configuration - DEBUG MODE
 * Server reported: "Failed to verify CertificateVerify" = Key Mismatch!
 *
 * Test results:
 * - TLS 1.3 + Server-TLS (8884): WORKS
 * - TLS 1.3 + mTLS (8883): Handshake fails - signature doesn't match certificate
 * - TLS 1.2 + mTLS (8883): pk_sign() fails with -0x4f80
 *
 * Using TLS 1.3 to debug which key OID is being used for signing.
 */
//#define MBEDTLS_SSL_PROTO_TLS1_2  /* Disabled - pk_sign() fails with Trust M */
#define MBEDTLS_SSL_PROTO_TLS1_3    /* Enabled for debugging */
 ...
 */
#define MBEDTLS_VERBOSE 0  /* Level 0 = Disabled - TLS works, save RAM */
 ...
 */
// #define MBEDTLS_DEBUG_C  /* DISABLED - TLS 1.3 handshake confirmed working */
 ...
 */
#define FORCE_TLS_VERSION MBEDTLS_SSL_VERSION_TLS1_2  /* Changed from TLS1_3 to fix PSA AEAD encrypt bug */
