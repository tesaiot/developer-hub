...
#warning "(PSE846GPS2DBZC4A: P11[4] (CYBSP_WIFI_HOST_WAKE, CYBSP_ETH_TX_CTL)) Block 'P11[4] (CYBSP_WIFI_HOST_WAKE, CYBSP_ETH_TX_CTL)' does not satisfy constraint imposed by param 'Host Device Interrupt Pin' on 'Wi-Fi'. The pin must be configured to generate interrupts on rising or falling edge."
