# Python MQTT over QUIC Client Example

This example demonstrates connecting to the TESA IoT Platform using MQTT over QUIC with Python.
...
**Option 1: NanoSDK Python bindings (Recommended for QUIC)**
```bash
pip install nng
```

**Option 2: Paho MQTT (Fallback - uses TCP+TLS)**
```bash
...
- **Username:** Your device_id (e.g., `05f8968a-b400-4727-9678-b53cb0889fce`)
