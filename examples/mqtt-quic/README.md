# MQTT over QUIC Connectivity Examples

This directory contains example code for connecting IoT devices to the TESA IoT Platform using **MQTT over QUIC** (UDP-based transport with TLS 1.3).

---

## Overview

MQTT over QUIC provides significant performance benefits over traditional MQTT over TCP:

- **50% faster initial connection** (1-RTT vs 2-RTT)
- **90% faster reconnection** (0-RTT session resumption)
- **Connection migration** (survives IP address changes)
- **Better weak network performance** (independent stream multiplexing)
...
Before running these examples, download your MQTT-QUIC Server-TLS Bundle from the Admin UI:

1. Navigate to your device in the Admin UI
2. Go to the **Credentials** tab
3. Click **Download MQTT-QUIC Server-TLS Bundle**
4. Extract the bundle to get:
