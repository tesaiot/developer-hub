...
lv_obj_t *ui_wifi_list_page_create(lv_obj_t *menu)
{
    ...
    lv_label_set_text(title_label, "WiFi Scan List (EP06)");
    ...
    s_ctx.use_ap_btn_label = lv_label_create(s_ctx.use_ap_btn);
    lv_label_set_text(s_ctx.use_ap_btn_label, "Use This AP");
    lv_obj_set_style_text_color(s_ctx.use_ap_btn_label, lv_color_hex(0xFFFFFF), LV_PART_MAIN);
    lv_obj_set_style_text_font(s_ctx.use_ap_btn_label, &lv_font_montserrat_14, LV_PART_MAIN);
    lv_obj_center(s_ctx.use_ap_btn_label);
