/*******************************************************************************
 * @file    main_example.c
 * @brief   Episode entry wrapper — HMI ep06: WiFi Profile NVM
 *
 ...
 *
 * This episode pre-initializes the WiFi scan service so that opening the
 * Scan page does not incur a long synchronous delay on the first tap.
 ******************************************************************************/
...
void example_main(lv_obj_t *parent)
{
    ...
    /* Warm up the WiFi stack so the first scan triggered from the UI does not
     * produce a visible 1-3 second stall. */
