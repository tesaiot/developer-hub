...
#define DISPLAY_I2C_CONTROLLER_hal_config CYBSP_I2C_DISPLAY_CONTROLLER_hal_config
#else
...
#define DISPLAY_I2C_CONTROLLER_hal_config CYBSP_I2C_CONTROLLER_hal_config
#endif
