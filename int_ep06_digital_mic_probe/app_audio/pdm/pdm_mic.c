...
cy_rslt_t pdm_mic_init(void)
{
    ...
    {
        printf("[EP06][MIC] SEMA_INIT_FAIL rslt=0x%08lx\r\n", (unsigned long)rslt);
        return rslt;
    }
    ...
    {
        printf("[EP06][MIC] PDM_INIT_FAIL rslt=0x%08lx\r\n", (unsigned long)pdm_rslt);
    ...
    {
        printf("[EP06][MIC] IRQ_LEFT_INIT_FAIL rslt=0x%08lx\r\n", (unsigned long)irq_left_rslt);
    ...
    {
        printf("[EP06][MIC] IRQ_RIGHT_INIT_FAIL rslt=0x%08lx\r\n", (unsigned long)irq_right_rslt);
    ...
    printf("[EP06][MIC] INIT_OK fs=%lu frame_samples=%u ch=L:2,R:3\r\n",
