...
void ui_wifi_list_create(void)
{
    ...
    lv_label_set_text(header_title, "WiFi List");
    ...
    lv_obj_t *home_page = create_full_content_page(menu,
                                                   "Home",
                                                   "Home",
                                                   "Home shell for WiFi list workshop.",
                                                   "Open WiFi tab, then tap Scan WiFi.");

    lv_obj_t *page_wifi = ui_wifi_list_page_create(menu);
